...
- **Qwen**: Integrated with the Qwen series models, including **qwen-turbo**, **qwen-plus** and the latest **qwen-max**. [Learn more](https://help.aliyun.com/zh/dashscope/developer-reference/model-introduction)
